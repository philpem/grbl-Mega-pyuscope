...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_Z_MAX_RATE 500.0 // mm/min
  #define DEFAULT_X_ACCELERATION (100.0*60.0*60.0) // 100 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (100.0*60.0*60.0) // 100 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (100.0*60.0*60.0) // 100 mm/sec^2
  ...
  // Defaults tuned for a CNC microscope stage (X/Y pan, Z focus) with TMC2209
  // drivers and sensorless X/Y homing. All values are applied only when EEPROM
  // is wiped ($RST=* or firmware version change); tune further via $-commands.
  //
  // Steps/mm assumes 200-step motor, 1/16 microstepping (TMC2209 with
  // MS1=MS2=HIGH via standard jumpers), and 2 mm pitch lead screw:
  // 200 * 16 / 2 = 1600 steps/mm. Adjust to match your actual mechanism.
  #define DEFAULT_X_STEPS_PER_MM 1600.0
  #define DEFAULT_Y_STEPS_PER_MM 1600.0
  #define DEFAULT_Z_STEPS_PER_MM 1600.0
  // Max rates: conservative for a delicate microscope stage.
  #define DEFAULT_X_MAX_RATE 500.0  // mm/min
  #define DEFAULT_Y_MAX_RATE 500.0  // mm/min
  #define DEFAULT_Z_MAX_RATE 100.0  // mm/min (focus axis: extra cautious)
  // Accelerations: gentle to protect stage mechanics and prevent false stalls.
  #define DEFAULT_X_ACCELERATION (20.0*60.0*60.0) // 20 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (20.0*60.0*60.0) // 20 mm/sec^2
  #define DEFAULT_Z_ACCELERATION  (5.0*60.0*60.0) //  5 mm/sec^2 (focus axis)
  // Travel limits: set to actual physical stage travel. Tune to your machine.
  ...
  #define DEFAULT_STEPPING_INVERT_MASK 0
  #define DEFAULT_DIRECTION_INVERT_MASK 0
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 255 // msec (255 = steppers always enabled)
  #define DEFAULT_STATUS_REPORT_MASK 1 // MPos enabled
  #define DEFAULT_JUNCTION_DEVIATION 0.01 // mm
  #define DEFAULT_ARC_TOLERANCE 0.002 // mm
  #define DEFAULT_REPORT_INCHES 0 // false
  #define DEFAULT_INVERT_ST_ENABLE 0 // false
  #define DEFAULT_INVERT_LIMIT_PINS 0 // false
  #define DEFAULT_SOFT_LIMIT_ENABLE 1 // true — prevents overtravel damaging optics
  #define DEFAULT_HARD_LIMIT_ENABLE 0 // false (DISABLE_HW_LIMITS set for RAMPS)
  #define DEFAULT_INVERT_PROBE_PIN 0 // false
  #define DEFAULT_LASER_MODE 0 // false
  #define DEFAULT_HOMING_ENABLE 1  // true — require homing before motion
  #define DEFAULT_HOMING_DIR_MASK 0 // home toward positive/max direction (bit set = toward min; bit clear = toward max)
